...
@section('content')
            <br><br>
                <form role="form" method="POST" action="{{ route('classroom_update', $classroom->id) }}">
                {!! csrf_field() !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                            <div class="input-mark-inner mg-b-22">
                                                <input type="text" class="form-control" name="class_name" id="class_name" value="{{ $classroom->class_name }}">
                                                <span class="help-block">Classroom Name</span>
                                            </div>
                                        </div>
                                    </div>
                                    <center>
