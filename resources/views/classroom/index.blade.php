                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Data Class</a></li>
                            </ul>
                                                                        ...
                                                                        <div class="sparkline13-graph">
                                                                            <div class="datatable-dashv1-list custom-datatable-overright">
                                                                                <div id="toolbar">
                                                                                    ...
                                                                                    <br>
                                                                                    <a href="{{ route('classroom_create') }}" type="button" class="btn btn-custon-four btn-success"><i class="fa fa-check edu-checked-pro" aria-hidden="true"></i> Add Class </a>
                                                                                </div>
                                                                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                                                                    ...
                                                                                    <thead>
                                                                                        <tr>
                                                                                            ...
                                                                                            <th data-field="name" data-editable="true">Class Name</th>
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        @foreach($classrooms as $classroom)
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <a class="btn btn-custon-rounded-four btn-warning" href="{{ route('classroom_edit', $classroom->id) }}"><i class="fa fa-exclamation-triangle edu-warning-danger" aria-hidden="true">Edit</i></a>
                                                                                                    <a class="btn btn-custon-rounded-four btn-danger" href="{{ route('classroom_delete', $classroom->id) }}"><i class="fa fa-times edu-danger-error" aria-hidden="true">Delete</i></a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        @php($i++)
                                                                                        @endforeach
