...
@section('content')
            <br><br>
                <form role="form" method="POST" action="{{ route('teacher_update', $teacher->id) }}">
                {!! csrf_field() !!}
                            ...
                            <div class="sparkline12-graph">
                                <div class="input-knob-dial-wrap">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                            <div class="input-mark-inner mg-b-22">
                                                <input type="text" class="form-control" name="age" id="age" value="{{ $teacher->age }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                            <div class="input-mark-inner mg-b-22">
                                                <input type="date" class="form-control" name="date_born" id="date_born" value="{{ $teacher->date_born }}">
