                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">User Setting</a></li>
                            </ul>
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        @foreach($users as $user)
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>{{ $user->email }}</td>
                                                                                                <td>
                                                                                                    <a class="btn btn-custon-rounded-four btn-warning" href="{{ route('user_edit', $user->id) }}"><i class="fa fa-exclamation-triangle edu-warning-danger" aria-hidden="true">Edit</i></a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        @php($i++)
                                                                                        @endforeach
